...
urlpatterns = [
    ...
    path('lost_posts/<int:post_pk>/comment/', CommentViewSet.as_view({'get': 'list', 'post': 'create'}),
         name='comment-list-for-post'),
    path('lost_posts/<int:post_pk>/comment/<int:pk>/', CommentViewSet.as_view({'get': 'retrieve', 'delete': 'destroy'})),
